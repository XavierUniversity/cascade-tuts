...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cascade-tuts/flexsearch.min.js');loadScript('/cascade-tuts/en.search-data.min.83c3befbc1ea82dcd7c8f850ba108ef8a37e6db2e1d26a62051a2cf3b3625cd0.js',function(){input.required=false;search();});}
