...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/cascade-tuts/flexsearch.min.js');loadScript('/cascade-tuts/en.search-data.min.53afc1f675b950bf3b0db9323f30da6a8530e110a9b600986d01d5a9cbb52da5.js',function(){input.required=false;search();});}
